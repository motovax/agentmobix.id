...
export const ShareSheet = forwardRef<ShareSheetHandle, ShareSheetProps>(function ShareSheet(
  ...
  type CaptionPackage =
    ...
    | { kind: "dpminim"; price: number; tdp: number; dpReal: number; cicilan: number; tenor: number }
      ...
      if (appliedSimulation.simTab === "dpminim") {
        ...
        if (tdp && cicilan) {
          return {
            ...
            price: captionPrice,
            tdp,
            dpReal: appliedSimulation.dp ?? shareDp ?? 0,
            cicilan,
    ...
    const protectedAiFactTerms = [
      ...
      ...(defaultDpMinim
        ? [
            ...
            formatJt(defaultDpMinim.dpReal),
