...
/** Threads (Meta) simplified mark for share channel picker. */
export function Threads({ size = 22, className }: IconProps) {
  return (
    <svg {...base(size)} viewBox="0 0 24 24" className={className} fill="currentColor">
      <path d="M12 3.5c-3.4 0-6 2.2-6 6.2 0 2.6 1.3 4.4 3.4 5.3-.2.5-.4 1.1-.4 1.7 0 1.7 1.1 2.8 2.9 2.8 2.6 0 4.5-2 4.5-5.1 0-2.1-.8-3.5-2.2-4.3 1 .6 1.7 1.7 1.7 3.2 0 3.3-1.9 5.5-4.8 5.5-2.5 0-4.1-1.6-4.1-3.9 0-3.4 2.9-5.4 5.9-5.4.7 0 1.4.1 2 .2V7.3c-.6-.1-1.3-.2-2-.2-1.5 0-2.8.5-3.7 1.3.7-2 2.5-3.1 4.8-3.1 3.2 0 5.5 2 5.5 5.6 0 4.2-2.7 7.1-6.6 7.1-2.7 0-4.7-1.5-4.7-3.7 0-.6.2-1.2.5-1.7-.3-.1-.6-.3-.9-.5C6.2 13.2 5 11.2 5 8.6 5 4.6 8.2 2 12 2c3.6 0 6.5 2.1 7.1 5.1h-2.1C16.5 5.1 14.5 3.5 12 3.5z" />
    </svg>
  );
}
