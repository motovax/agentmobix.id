...
export const TESTIMONIALS: Testimonial[] = [
  ...
  },
  {
    ...
    quote:
      "AI Mobix Assistant kerasa banget bantuannya. Customer minta video keliling, tinggal chat, dalam setengah jam foto dan video sudah siap. Saya tinggal teruskan.",
